...
export default function Profile() {
  ...
  const [user, setUser] = useState<UserProfile>({
    ...
    avatar: "/images/avatar.png", // place avatar.png in public/images
    points: 1240,
    level: 5,
    quizzesTaken: 18,
  });
  ...
  const achievements = [
    { title: "Eco Warrior 🌱", desc: "Completed 10 eco-friendly challenges" },
    { title: "Recycler ♻️", desc: "Recycled 100+ items" },
    { title: "Green Streak 🔥", desc: "Logged in for 7 days in a row" },
  ];
      ...
      <div className="max-w-4xl mx-auto bg-white dark:bg-gray-900 shadow-xl rounded-2xl p-8">
        ...
        <div className="grid grid-cols-3 gap-6 mb-8">
          ...
          <div className="bg-purple-300 dark:bg-purple-800 rounded-xl p-4 text-center">
            ...
            <p className="text-gray-600 dark:text-gray-300">Quizzes</p>
          </div>
        </div>
